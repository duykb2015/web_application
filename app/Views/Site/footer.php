...
<div class="container-fluid bg-secondary text-dark mt-5 pt-5">
    <div class="row px-xl-5 pt-5">
        <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
            ...
            <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>Chi nhánh 1: Example address</p>
            ...
            <div class="row">
                <div class="col-md-4 mb-5">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        ...
                        <a class="text-dark mb-2"><i class="fa fa-angle-right mr-2"></i>Chi tiết</a>
                ...
                <div class="col-md-4 mb-5">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        <a class="text-dark mb-2"><i class="fa fa-angle-right mr-2"></i>Hướng dẫn mua hàng</a>
                        <a class="text-dark mb-2"><i class="fa fa-angle-right mr-2"></i>Chính sách Bảo hành & Đổi trả</a>
                        <a class="text-dark mb-2"><i class="fa fa-angle-right mr-2"></i>Chính sách vận chuyển</a>
                        <a class="text-dark mb-2"><i class="fa fa-angle-right mr-2"></i>Câu hỏi thường gặp</a>
    ...
    <div class="row border-top border-light mx-xl-5 py-4">
        <div class="col-md-6 px-xl-0">
            <p class="mb-md-0 text-center text-md-left text-dark">
                &copy; <a class="text-dark font-weight-semi-bold" href="#">E-Shopper</a>
            </p>
        </div>
